...
function show_history(num) {
    console.log('show_history 호출됨:', num); // 디버그용
    ...
    console.log('팝업 요소들:', { titleElement, contentElement, popupElement });
    
    if (!titleElement || !contentElement || !popupElement) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (bgClose) {
        ...
        bgClose.addEventListener('touchmove', preventScroll, { passive: false });
        bgClose.addEventListener('touchstart', preventScroll, { passive: false });
    }
    
    // ESC 키로 팝업 닫기
    document.addEventListener('keydown', function(e) {
        if (e.key === 'Escape' && popupWrap && (popupWrap.style.display === 'flex' || popupWrap.style.display === 'block')) {
            closePopup();
        }
    });
