    ...
    <div class="content-card">
        <div class="boho">
            <div class="info1">
                ...
                <strong>본 방침은 : 2014년 8월 7일 부터 시행됩니다.</strong>
            </div><!--info1-->
            ...
            <div class="info2">
                ...
                <ul>
                    ...
                    <li><strong>수집항목</strong> : 이름, 생년월일, 성별, 로그인ID, 비밀번호, 비밀번호 질문과 답변, 자택 전화번호, 자택 주소, 휴대전화번호, 이메일, 주민등록번호, 쿠키, 결제기록</li>
                    <li><strong>개인정보 수집방법</strong> : 홈페이지(회원가입)</li>
                    <li>단, 예외적으로 자원봉사 및 후원신청, 실습신청 시 아래와 같은 개인정보를 추가 수집하고 있습니다.
                        <ul>
                            <li>1) <strong>수집방법</strong> : 홈페이지(자원봉사 신청)<br>
                            <strong>수집항목</strong> : 생년월일, 우편번호, 자택주소, 전화번호, 휴대폰, 최종학력, 직업, 참여동기, 활동경험, 희망분야, 활동시간, 자기소개, 파일첨부</li>
                            <li>2) <strong>수집방법</strong> : 홈페이지(후원 신청)<br>
                            <strong>수집항목</strong> : 주민번호, 우편번호, 자택주소, 자택전화, 휴대폰, 직업, 후원형태, 희망기간, 후원분류, 후원금액, 납부방법, (자동이체선택시) 은행명, 계좌번호, 건의사항, 파일첨부</li>
                            <li>3) <strong>수집방법</strong> : 홈페이지(실습 신청)<br>
                            <strong>수집항목</strong> : 생년월일, 우편번호, 자택주소, 자택전화, 휴대폰, 종교, 학교명, 학년, 학과, 실습신청기간, 건의사항, 파일첨부</li>
                        </ul>
                    </li>
                </ul>
                ...
                <ul>
                    ...
                    <li>회원제 서비스 이용에 따른 본인확인, 개인 식별, 불량회원의 부정 이용 방지와 비인가 사용 방지, 가입 의사 확인, 연령확인, 불만처리 등 민원처리, 고지사항 전달, 접속 빈도 파악 또는 회원의 서비스 이용에 대한 통계</li>
                </ul>

                <h3>■ 개인정보의 보유 및 이용기간</h3>
                <ul>
                    <li>원칙적으로, 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다.</li>
                    <li>단, 관계법령의 규정에 의하여 보존할 필요가 있는 경우 회사는 아래와 같이 관계법령에서 정한 일정한 기간 동안 회원정보를 보관합니다.
                        <ul>
                            <li><strong>보존 항목</strong> : 결제기록</li>
                            <li><strong>보존 근거</strong> : 계약 또는 청약철회 등에 관한 기록</li>
                ...
                <ul>
                    <li>회사는 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체없이 파기합니다.</li>
                ...
                <h3>■ 수집한 개인정보의 위탁</h3>
                <ul>
                    <li>회사는 서비스 이행을 위해 아래와 같이 외부 전문업체에 위탁하여 운영하고 있습니다.
                        <ul>
                            <li><strong>위탁 대상자</strong> : (주)○○○</li>
                            <li><strong>위탁업무 내용</strong> : 웹사이트 및 시스템 관리</li>
                        </ul>
                    </li>
                </ul>
                ...
                <ul>
                    ...
                    <li>또한 잘못된 개인정보를 제3자에게 이미 제공한 경우에는 정정 처리결과를 제3자에게 지체없이 통지하여 정정이 이루어지도록 하겠습니다.</li>
                    <li>회사는 이용자의 요청에 의해 해지 또는 삭제된 개인정보는 "회사가 수집하는 개인정보의 보유 및 이용기간"에 명시된 바에 따라 처리하고 그 외의 용도로 열람 또는 이용할 수 없도록 처리하고 있습니다.</li>
                </ul>

                <h3>■ 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항</h3>
                <ul>
                    <li>회사는 귀하의 정보를 수시로 저장하고 찾아내는 '쿠키(cookie)' 등을 운용합니다.</li>
                    <li>쿠키란 웹사이트를 운영하는데 이용되는 서버가 귀하의 브라우저에 보내는 아주 작은 텍스트 파일로서 귀하의 컴퓨터 하드디스크에 저장됩니다.</li>
                    <li>회사은(는) 다음과 같은 목적을 위해 쿠키를 사용합니다.
                        <ul>
                ...
                <div class="date-info">
                    <p><strong>공고일자</strong> : 2014년 6월 30일</p>
                    <p><strong>시행일자</strong> : 2014년 6월 30일</p>
                </div>
            </div><!-- info2 -->
        </div><!-- boho -->
    </div><!-- content-card -->
