    ...
    <div class="content-card">
        <div class="business-content">
            <div class="info-section">
                <h3 class="section-title-with-icon2">기금후원(정기, 일시)</h3>
            ...
            <div class="info-section">
                <h3 class="section-title-with-icon2">물품후원(정기, 일시)</h3>
                <p>어르신과 복지관에 필요한 물품을 후원 할 수 있습니다.</p>
            </div>

            <div class="info-section">
                <h3 class="section-title-with-icon2">지정후원</h3>
            ...
            <div class="info-section">
                <h3 class="section-title-with-icon2">모금통</h3>
                <p>회사나 상점 등에 안성시노인복지관의 모금통을 비치하여 자유로운 모금을 통해 후원 할 수 있습니다.</p>
            </div>

            <div class="info-section">
                <h3 class="section-title-with-icon2">후원혜택</h3>
                <ul>
