        ...
        <tr>
            ...
            <td>
                <div id="autosave_wrapper">
                    <input type="text" name="wr_subject" value="<?php if($subject == '') {  echo $write['wr_1'].'의 식단'; } else { echo $subject; } ?>" id="wr_subject" required class="frm_input required" size="50" maxlength="255">
