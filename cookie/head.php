...
<div id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <div id="logo">
            <a href="<?php echo G5_URL ?>"><img src="<?php echo G5_THEME_IMG_URL ?>/mobile/logo.png" alt="<?php echo $config['cf_title']; ?>"></a>
        </div>
...
<div id="wrapper">
    ...
    <div id="container">
        <?php if (!defined("_INDEX_")) { ?><h2 id="container_title m1_s1"><span title="<?php echo get_text($g5['title']); ?>"><?php echo get_head_title($g5['title']); ?></span></h2><?php } ?>
